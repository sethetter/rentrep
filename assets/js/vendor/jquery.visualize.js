...
//TWEAK: calculation tweaks added by Christian Taylor 6.7.14
(function($) { 
		...
		function scrapeTable(){
			...
			var tableData = {
				...
				topValue: function(){
						...
						return Math.ceil(topValue / 5) * 5; //TWEAK: rounded off to the nearest 5th
				},
		...
		var createChart = {
			pie: function(){	
				...
				$.each(memberTotals, function(i){
			        ...
			        var percentage = parseFloat((fraction*100).toFixed(1));  //TWEAK: 1 decimal place instead of 2
